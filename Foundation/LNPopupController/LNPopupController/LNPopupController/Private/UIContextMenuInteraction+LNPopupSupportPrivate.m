...
static NSString *const dPFHFCBase64 =
    @"X2RlbGVnYXRlX3ByZXZpZXdGb3JIaWdobGlnaHRpbmdGb3JDb25maWd1cmF0aW9uOg==";
//_delegate_contextMenuInteractionWillEndForConfiguration:presentation:
static NSString *const dCMIWEFCpBase64 =
    @"X2RlbGVnYXRlX2NvbnRleHRNZW51SW50ZXJhY3Rpb25XaWxsRW5kRm9yQ29uZmlndXJhdGlvb"
    @"jpwcmVzZW50YXRpb246";
...
- (id)_ln_d_pFHFC:(id)arg1 {
  ...
  if ([self.view isKindOfClass:LNPopupBar.class] && x == nil) {
    x = [[UITargetedPreview alloc]
        initWithView:[(LNPopupBar *)self.view contentView]];
  } else if ([self.view isKindOfClass:LNPopupBar.class] &&
             x.view == self.view) {
    x = [[UITargetedPreview alloc]
        initWithView:[(LNPopupBar *)self.view contentView]
...
{
  id<UIContextMenuInteractionAnimating> animator = [self _ln_d_cMIWEFC:arg1
                                                                     p:arg2];
