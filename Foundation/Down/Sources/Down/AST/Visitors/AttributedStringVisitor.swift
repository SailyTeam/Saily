...
//
    ...
    extension AttributedStringVisitor: Visitor {
        ...
        public func visit(thematicBreak _: ThematicBreak) -> NSMutableAttributedString {
        ...
        public func visit(softBreak _: SoftBreak) -> NSMutableAttributedString {
            let result = (options.contains(.hardBreaks) ? String.lineSeparator : " ").attributed
            styler.style(softBreak: result)
            return result
        }

        public func visit(lineBreak _: LineBreak) -> NSMutableAttributedString {
    ...
    private extension NSAttributedString {
        static var paragraphSeparator: NSAttributedString {
            String.paragraphSeparator.attributed
        }
    }
