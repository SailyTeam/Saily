...
public extension DownASTRenderable {
    ...
    func toAST(_ options: DownOptions = .default) throws -> CMarkNode {
        try DownASTRenderer.stringToAST(markdownString, options: options)
    }
    ...
    func toDocument(_ options: DownOptions = .default) throws -> Document {
