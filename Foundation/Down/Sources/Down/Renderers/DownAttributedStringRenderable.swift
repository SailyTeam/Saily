...
//
    ...
    public extension DownAttributedStringRenderable {
        ...
        func toAttributedString(_ options: DownOptions = .default,
        ...
        func toAttributedString(_ options: DownOptions = .default, styler: Styler) throws -> NSAttributedString {
            let document = try toDocument(options)
